...
public class AssignNCLEX_RN_PasspointExam_Test extends BaseTest {
	...
	public void Test02_Login_To_The_Application_With_Right_User_Credentials() {
		...
		test.myClassPage.selectClassOnMyClassesPage(getData("users.instructor.class>3.RNClass"));
	...
	@Test
	public void Test05_Number_Of_Questions_DropDown_Should_Include_75_100_150_200_265() {
		List<String> expectedOptions = Arrays.asList(new String[] { "75", "100", "150", "200", "265"});
		Assert.assertEquals(test.assignmentsPage.getNumberOfQuestionOptions(),
				expectedOptions);
		test.assignmentsPage.selectNumberOfQuestions("265");
		test.assignmentsPage.selectNumberOfQuestions("200");
		test.assignmentsPage.selectNumberOfQuestions("150");
		test.assignmentsPage.selectNumberOfQuestions("100");
		test.assignmentsPage.selectNumberOfQuestions("75");
	}
	
	@Test
	public void Test06_Select_Class(){
		System.out.println("class is "+ getData("users.student.class>3.RNClass"));
		try{
			test.assignYourQuizPage.selectCheckBoxCorrespondingToClassForExam(getData("users.student.class>3.RNClass"));
		}
		catch (Exception e)
		{
			System.out.println("Caugh in exception");
		}
	}
	
	@Test
	public void Test07_Click_on_Assign_buutton(){
	...
	@Test
	public void Test08_Click_on_Done_button_And_Navigate_to_HMCD(){
	...
	@Test
	public void Test09_Logout_From_Instructor_Account(){
		test.loginHeader.userSignsOutOfTheApplication();

	}
	
	@Test 
	public void Test10_Login_As_A_Studnet(){
		test.loginPage.selectSubject(getData("users.bio_subject"));
	...
	@Test
	public void Test11_Goto_AssignemntsPage() {
		test.navigationBarHeader.selectAssignmentsTab();
		
	}
	
	@Test
	public void Test12_Select_And_Start_The_Assigned_Exam(){
	...
	@Test
	public void Test13_Attempt_Assigned_Exam() throws InterruptedException, ClassNotFoundException {
		int i =1;
		for (int currentQuestionNo = 1; currentQuestionNo <= 75; currentQuestionNo++) {
			try{
				test.questionPresentScreen.verifyProgerssBarStatusAccuracy(currentQuestionNo, 75);
	...
	@Test
	public void Test14_Navigate_To_HMCD_And_Logout_From_The_Application(){
	...
	@Test
	public void Test15_Login_As_Instructor() {
	...
	@Test
	public void Test18_Logout_From_The_Application(){
		test.loginHeader.userSignsOutOfTheApplication();	
	}
