...
public class StudentAttemptPracticeQuizInNursingTopicCategoryTest extends BaseTest{
	...
	public void Test03_Select_Practice_Quiz_Tab_And_Select_Chapter_And_Attempt_All_Questions(String productName){
		...
		test.practiceQuiz.selectParticularChapter(getData("E2E.chapter_name.nursing_topic"));
