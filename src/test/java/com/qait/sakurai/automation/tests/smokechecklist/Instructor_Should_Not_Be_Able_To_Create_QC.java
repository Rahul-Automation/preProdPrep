...
public class Instructor_Should_Not_Be_Able_To_Create_QC extends BaseTest {

	/* PBI 8172 Test Cases Automation */
	...
	@Test
	@Parameters({"productName"})
	public void Test06_Verify_Error_Message_In_Red_On_Creating_QC_Folder_With_Same_Name_From_Add_To_Collection_Dropdown(String productName) {
		if(productName.equalsIgnoreCase("Hinkle")) {
		test.questionLibraryPage.selectAChapter2("Chapter 9: Chronic Illness and Disability");
		}else {
			test.questionLibraryPage.selectAChapter(YamlReader.getYamlValue("E2E.chapter_name.nursing_topic"));
		}
	...
	@Test
	public void Test09_Verify_Error_Message_In_Red_On_Creating_QC_Folder_With_Same_Name_By_Copying_A_QC_Folder() {
	...
	@Test
	public void Test10_Verify_Error_Message_In_Red_On_Creating_QC_Folder_With_Same_Name_By_Copying_A_QC_Folder_Regardless_Of_Capitalization() {
		test.questionLibraryPage.clickOnManageDropdownAndSelectParticularOption("Copy");
		test.questionLibraryPage.enterQuestionCollectionName(qcFolderName1);
		test.questionLibraryPage.clickOnCreateButton();
		test.questionLibraryPage
	...
	@Test
	public void Test11_Verify_Instructor_Is_Able_To_Delete_The_QC_Folder(){
	...
	@Test
	public void Test12_Create_A_New_Question_Collection_Folder_With_Name_That_Have_Been_Deleted() {
		test.questionLibraryPage.CreateAQuestionCollection(qcFolderName);
		test.questionLibraryPage.verifyQuestionCollectionCreatedSuccessfullyAndDisplayedInLeftPanel(qcFolderName);
	    test.questionLibraryPage.clickOnQCFolderFromLeftPanelAndVerifyInstructorIsParticularQCFolderPage(qcFolderName);
		test.questionLibraryPage.clickOnManageDropdownAndSelectParticularOption("Delete");
