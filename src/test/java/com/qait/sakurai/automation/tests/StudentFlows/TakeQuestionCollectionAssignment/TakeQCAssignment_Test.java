 ...
 * 
 */
public class TakeQCAssignment_Test extends BaseTest {
	...
	public void Test02_Create_Question_Collection() {
		...
		String CollectionName = test.questionLibraryPage
		...
		list1 = test.questionLibraryPage.getListOfQuestionCollection(CollectionName);
	}

	@Test
	public void Test03_Assign_Different_QC_Quizes() {
		qcAssignment1 = createQuestionCollectionAssignment();
		qcAssignment2 = createQuestionCollectionAssignment();
	}
	...
	public void Test04_Navigate_To_Anchor_Assignment_Results_And_Verify_Question_Collection_Assignment_Heading() {
		...
		test.hmcdPage.verifyQuestionCollectionAssignmentHeading();
	}

	@Test
	public void Test05_Verify_Default_Sort_Is_On_Start_Date() {
		test.hmcdPage.verifyDefaultSortIsAppliedOnStartDate();
	}
	...
	public void Test06_Verify_Assignment_Name_Is_Displayed_Under_QC_Assignment_Table() {
		...
		test.hmcdPage.verifyAssignmentNameIsDisplayedUnderQCAssignmentTable(qcAssignment1);
	}
	...
	public void Test07_Verify_Number_Of_Question_Corressponding_To_The_Assignment() {
		/*assignName = PropFileHandler.readProperty("QCQuizUnTimed",
				getData("propertyfilepath"));*/
		test.hmcdPage.verifyNumberOfQuestionInQcQuiz(qcAssignment1, 5);
	}
	...
	public void Test08_Verify_StartDate_And_EndDate_Is_Displayed_For_QC_Quiz() {
		/*assignName = PropFileHandler.readProperty("QCQuizUnTimed",
				getData("propertyfilepath"));*/
		test.hmcdPage.verifyStartDateAndEndDateIsDisplayedForQCQuiz(qcAssignment1);
	}
	...
	public void Test12_Verify_Information_For_QCAssignment_On_AssignmentsTab() {
		...
		test.assignmentsPage.verifyQCAssignName(qcAssignment1);
		test.assignmentsPage.verifyQCQuizStartAndEndDateAssignmentsTab(qcAssignment1);
		test.assignmentsPage.verifyQCQuizNoOFQuestions(qcAssignment1, "5");
		test.assignmentsPage.verifyPointValue(qcAssignment1,
				getData("QCAssignment.defaultPointValue"));
		test.assignmentsPage.verifyScoreIfNotStarted(qcAssignment1);
	}
	...
	public void Test13_Verify_PastDue_Message_For_QCQuiz() {
		test.navigationBarHeader.selectAssignmentsTab();
		test.assignmentsPage.verifyPastDueStatus(qcAssignment2);
		/*test.assignmentsPage.verifyPastDueStatus(PropFileHandler.readProperty(
	...
	public void Test14_Verify_Score_Zero_Out_Of_Point_Value_For_PastDue_QC_Assignment() {
		test.assignmentsPage
				.verifyScoreZeroOutOfPointValueForPastDueQCAssignment(qcAssignment2);
	}
	...
	public void Test15_Verify_PastDue_Status_After_Clicking_On_Assignment() {
		test.assignmentsPage
				.verifyPastDueStatusAfterClickingOnAssignment(qcAssignment2);
	}

	@Test
	public void Test16_Verify_Assignment_Information_Of_Past_Due_QC_Assignment() {
		test.assignmentsPage
				.verifyAssignmentInformationOfPastDueQCAssignment(qcAssignment2);
	}

	@Test
	public void Test17_Verify_Assignment_Message_For_Past_Due_QC_Assignment() {
		test.assignmentsPage.verifyMessageForPastDueQCAssignment();
	}
	...
	public void Test19_Start_Untimed_Quiz_And_Verify_Order_Of_Questions() {
		...
		test.assignmentsPage.selectAssignment(qcAssignment1);
	...
	public void Test20_Answer_FirstThreeQuestions_Verify_QuesOrder_ExitQuiz() {
		for (int quesNo = 0; quesNo < 3; quesNo++) {
			...
			test.questionLibraryPage.compareQCQuizQuestionOrder(quesNo, list1);
	...
	public void Test21_Answer_Remaining_Questions_And_Verify_Order() {
		...
		test.practiceQuizHistoryPage.clickFinishQuizLinkForAssignment(qcAssignment1);
	...
	public void Test25_Is_Number_Of_Question_Correctly_Answer_Out_Of_Total_Displayed() {
		test.quizResultsPage.IsNumberOfQuestionCorrectlyAnswerOutOfTotalDisplayed();
	}
	...
	public void Test26_Verify_AnswerKey_Immediately_After_The_Assignment_On_Quiz_Results_Page() {
		test.quizResultsPage.verifyAnswerKeyShowQuestionAnsweredByStudent(5);
	}
	...
	public void Test27_Verify_Assignment_Status_Complete_For_AssignmentsTab() {
		...
		test.navigationBarHeader.selectAssignmentsTab();
		test.assignmentsPage.verifyCompleteStatus(qcAssignment1);
	}
	...
	public void Test30_Verify_Average_Score_Out_Of_Point_Value_On_Hmcd_Page() {
		...
		assignName = PropFileHandler.readProperty("QCQuizUnTimed",
				getData("propertyfilepath"));
		test.hmcdPage.verifyAverageScoreOutOfPointValueOnHmcdPage(qcAssignment1);
	}
	...
	public void Test31_Navigate_To_Anchor_Assignment_Result_And_Verify_User_Is_Not_Able_To_Click_QC_Quiz_Which_Is_Not_Taken_By_Any_Student() {
		assignName = PropFileHandler.readProperty("QCQuizPastDue",
				getData("propertyfilepath"));
		Assert.assertTrue(test.hmcdPage.verifyUserIsNotAbleToClickQCQuizWhichIsNotTakenByAnyStudent(qcAssignment1),"[FAILED]: User is able to click the QC Quiz Which is Not Taken By Any Student");
	}
	...
	public void Test32_Click_On_QC_Quiz_Which_Is_Completed_By_AtLeast_A_Student_And_Verify_User_On_Clicking_User_Navigated_To_Assignment_Results_Summary_page() {
		assignName = PropFileHandler.readProperty("QCQuizUnTimed",
				getData("propertyfilepath"));
		qcQuizScore = test.hmcdPage.getAverageScoreOfQCQuizFromHmcdPage(qcAssignment1);
		test.hmcdPage.clickOnQCQuizWhichIsCompletedByAtLeastAStudent(qcAssignment1);
		test.hmcdPage.verifyUserIsOnAssignmentResultsSummaryPage();
	}
	...
	public void Test35_Verify_Class_Name_For_QC_Quiz_On_Assignment_Results_Summary_Page() {
		test.assignmentSummaryPage.verifyClassNameForAssignment(getData("users."
				+ "instructor.class=1.class_name"));
	}
	...
	public void Test37_Verify_Number_Of_Student_Completed_Out_Of_Total_Student() {
		test.assignmentSummaryPage.verifyNoOfStudentCompletedOutOfTotalStudent();
	}
	...
	public void Test38_Verify_Average_Score_For_The_Assignment() {
		test.assignmentSummaryPage.verifyAvgScoreForTheAssignment();
	}
	...
	public void Test39_Verify_Student_Result_Table_Is_Displayed() {
		test.instructorStudentAssignmentResultsPage
	...
	public void Test48_Click_On_Student_Name_And_Verify_A_New_Window_Open() {
		test.hmcdPage.clickOnStudentNameUnderStudentUsageTable();
		test.changeWindow(1);
	}
	...
	public void Test51_Click_On_Completed_Assignment_And_Verify_User_Is_Assignment_Information_Page() {
		...
		test.assignmentsPage.selectAssignment(qcAssignment1);
		test.assignmentsPage.verifyAssignmentName(qcAssignment1);
	}
	...
	public void Test55_Verify_Take_Another_Quiz_Link_Is_Not_Displayed() {
		test.quizResultsPage.verifyTakeAnotherQuizLinkIsNotDisplayed();
	}

	@Test
	public void Test56_Verify_View_Overall_Perfomance_Button_Is_Not_Displayed() {
		test.quizResultsPage.verifyViewOverallPerformanceIsNotDisplayed();
	}

	@Test
	public void Test57_Click_On_Go_Back_To_Assignments_And_Verify_User_Is_On_Assignment_List_Page() {
		test.quizResultsPage.clickOnGoBackToAssignmentsButton();
		test.assignmentsPage.verifyUserIsOnAssignmentsPage();
	}
