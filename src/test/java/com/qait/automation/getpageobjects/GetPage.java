...
public class GetPage extends BaseUi {
	...
	protected List<String> clickListElementsUsingText(String elementToken, String text) {
		List<String> options = new ArrayList<String>();
		List<WebElement> elements = elements(elementToken);
		for (WebElement element : elements) {
	...
	protected boolean isRadioButtonSelected(String elementToken) {
		...
		assertTrue(result, "Assertion Failed: radio button '" + elementToken + "' is not selected.");
		logMessage("Assertion Passed: radio button " + elementToken + " is selected.");
		return result;
	}
	...
	protected WebElement element2(String elementToken, String replacement) throws NoSuchElementException {
		WebElement elem = null;
		try {
			elem = wait.waitForElementToBeClickable(driver.findElement(getLocator(elementToken, replacement)));
		} catch (NoSuchElementException excp) {
			// fail("FAILED: Element "+ elementToken + " not found on the " + this.pageName
			// + " !!!");
	...
	protected WebElement element1(String elementToken, String replacement) throws NoSuchElementException {
		WebElement elem = null;
		try {
			elem = wait.waitForElementToBeVisible(driver.findElement(getLocator(elementToken, replacement)));
		} catch (NoSuchElementException excp) {
	...
	protected WebElement element(String elementToken, String first_Rep, String sec_Rep) throws NoSuchElementException {
		WebElement elem = null;
		try {
			elem = wait.waitForElementToBeVisible(driver.findElement(getLocator(elementToken, first_Rep, sec_Rep)));
	...
	protected List<WebElement> elements(String elementToken, String first_rep, String sec_repl) {
		return wait.waitForElementsToBeVisible(driver.findElements(getLocator(elementToken, first_rep, sec_repl)));
	}
	...
	protected boolean isElementNotDisplayed(String elementName) {
		...
		logMessage("Assertion Passed: element " + elementName + " is not displayed as intended.");
		return result;
	}
