...
public class BaseUi {
	...
	public void hardWaitForIEBrowser(int seconds) {
		if (getProperty("Config.properties", "browser").equalsIgnoreCase("IE")
				|| getProperty("Config.properties", "browser").equalsIgnoreCase("ie")
				|| getProperty("Config.properties", "browser").equalsIgnoreCase("internetexplorer")) {
	...
	protected void verifyPageTitleExact(String expectedPagetitle) {
		try {
			...
			Assert.fail("FAILED: PageTitle for " + pageName + " is not exactly: '" + expectedPagetitle
					+ "'!!!\n instead it is :- " + driver.getTitle());
		}
		logMessage("PASSED: PageTitle for " + pageName + " is exactly: '" + expectedPagetitle + "'");
	}
	...
	protected void verifyPageTitleContains(String expectedPagetitle) {
		...
		logMessage("PASSED: PageTitle for " + actualPageTitle + " contains: '" + expectedPagetitle + "'.");
	}
	...
	protected void verifyElementIsHyperlinked(WebElement element) {
		Assert.assertTrue(isElementAHyperlink(element),
				"[Failed]: Element \'" + element.getText() + "\' is not a hyperlink");
	...
	protected void verifyElementIsNotHyperlinked(WebElement element) {
		...
		Assert.assertTrue(!(isElementAHyperlink(element)),
				"[Failed]: Element \'" + element.getText() + "\' is a hyperlink");
